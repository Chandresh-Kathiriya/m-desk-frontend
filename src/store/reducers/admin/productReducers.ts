...
export const productListReducer = (state: ProductListState = { products: [] }, action: any): ProductListState => {
  switch (action.type) {
    case PRODUCT_LIST_REQUEST: return { loading: true, products: [] };
    case PRODUCT_LIST_SUCCESS: return { loading: false, products: action.payload.products };
...
export const productDetailsReducer = (state: ProductDetailsState = { product: {} }, action: any): ProductDetailsState => {
  switch (action.type) {
    ...
    case PRODUCT_DETAILS_RESET: return { product: {} };
    default: return state;
  }
};
...
export const productCreateReducer = (state: ProductMutationState = {}, action: any): ProductMutationState => {
  switch (action.type) {
...
export const productUpdateReducer = (state: ProductMutationState = {}, action: any): ProductMutationState => {
  switch (action.type) {
...
export const productDeleteReducer = (state: ProductMutationState = {}, action: any): ProductMutationState => {
  switch (action.type) {
