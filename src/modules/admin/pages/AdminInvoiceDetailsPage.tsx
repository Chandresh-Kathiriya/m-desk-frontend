...
import styles from '../../../schemas/css/AdminInvoiceDetailsPage.module.css';
    ...
    return (
        <main className={styles['page-wrapper']}>
            <div className={styles.container}>
                ...
                <Link to="/admin/invoices" className={styles['back-link']}>
                ...
                <div className={styles.card}>
                    ...
                    <div className={styles['info-grid']}>
                        <div className={styles['info-column']}>
                            <h3 className={styles['info-label']}>Billed To (Contact)</h3>
                        ...
                        <div className={`${styles['info-column']} ${styles['info-column--right']}`}>
                            ...
                            <div className={styles['info-value']}>
                                ...
                                <Link to={`/admin/order/${invoice.salesOrder?._id}`} className={styles['info-link']}>
